    ...
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px] relative'>
            ...
            <div className='absolute w-full h-full text-gray-200 max-h-[500px] bg-black/40 flex flex-col justify-center'>
                ...
                <p className='px-4 text-4xl sm:text-1xl md:text-2xl lg:text-2xl font-bold my-5 w-[600px]'>Eat Fresh and helthy food. Fastest delivery you have ever seen. Just choose and tap order.</p>
            </div>
